...
@section('content')
    <div class="row">
        <div class="col-md-12 mb-4">
            <h2 class="fw-bold">{{ __('message.dashboard') }}</h2>
        </div>

        <div class="col-md-3">
            <div class="card p-3 bg-white border-start border-primary border-4">
                <p class="text-muted mb-1">{{ __('message.total_campaigns') }}</p>
        ...
        <div class="col-md-3">
            <div class="card p-3 bg-white border-start border-success border-4">
                <p class="text-muted mb-1">{{ __('message.total_subscribers') }}</p>
        ...
        <div class="col-md-3">
            <div class="card p-3 bg-white border-start border-warning border-4">
                <p class="text-muted mb-1">{{ __('message.pending_jobs') }}</p>
        ...
        <div class="col-md-3">
            <div class="card p-3 bg-white border-start border-danger border-4">
                <p class="text-muted mb-1">{{ __('message.sent_notifications') }}</p>
